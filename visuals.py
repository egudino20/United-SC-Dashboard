...
def createShotmap(events_df, fig, ax, pitch, team, players, view, competition, season_year, pitchcolor, shot_color, titlecolor, team_color, fontfamily):

    total_shots = calc_xg(events_df)
